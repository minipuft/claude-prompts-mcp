...
export class SymbolicCommandParser {
    ...
    parseChainOperator(command) {
        ...
        cleanCommand = this.stripStyleOperators(cleanCommand);
    ...
    cleanStepOperators(stepStr) {
        ...
        cleaned = this.stripStyleOperators(cleaned);
        return cleaned.trim();
    }
    /**
...
//# sourceMappingURL=symbolic-command-parser.js.map