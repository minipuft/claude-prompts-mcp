...
import type { InjectionConfig, InjectionDecisionInput, InjectionDecisionSource, InjectionRuntimeOverride, InjectionType, ResolvedInjectionConfig } from '../types.js';
/**
 ...
 */
export declare const DecisionResolver: typeof HierarchyResolver;
