...
export class PromptGuidanceStage extends BasePipelineStage {
    constructor(promptGuidanceService, logger) {
        super(logger);
    ...
    async applyGuidance(prompt, context, promptId = prompt.id) {
        try {
            ...
            const semanticAnalysis = context.metadata['semanticAnalysis'];
            const selectedResources = context.metadata['selectedResources'];
            const availableResources = context.metadata['availableGuidanceResources'];
    ...
    getGuidanceStore(context) {
        ...
        return context.metadata['promptGuidanceResults'];
    }
    /**
