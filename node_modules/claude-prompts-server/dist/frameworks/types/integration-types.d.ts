...
export interface IFrameworkSemanticIntegration {
     ...
     */
    analyzeWithFrameworkIntegration(prompt: ConvertedPrompt, userFrameworkPreference?: string): Promise<IntegratedAnalysisResult>;
    /**
...
export interface IMCPToolIntegration {
     ...
     */
    handleToolRequest(context: MCPToolIntegrationContext): Promise<MCPToolIntegrationResult>;
    /**
     * Register MCP tool for integration
     */
    registerTool(toolName: string, integrationHandler: (context: MCPToolIntegrationContext) => Promise<any>): void;
    /**
