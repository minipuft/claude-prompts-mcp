...
export class FrameworkManager {
     ...
     */
    isApplicable(framework, criteria) {
     ...
     */
    calculateFitScore(framework, criteria) {
        ...
        if (criteria.complexity) {
            switch (criteria.complexity) {
                case 'high':
                    if (framework.methodology === 'CAGEERF')
                        score += 15;
                    break;
                case 'medium':
                    if (framework.methodology === 'ReACT' || framework.methodology === '5W1H')
                        score += 10;
                    break;
                case 'low':
                    if (framework.methodology === 'SCAMPER')
                        score += 5;
                    break;
            }
        }
...
Apply this methodology systematically to ensure comprehensive and structured responses.`;
     ...
     */
    setFrameworkEnabled(methodology, enabled) {
 ...
 */
export async function createFrameworkManager(logger) {
