...
export async function initializeModules(params) {
    ...
    const mcpToolsManager = await createMcpToolsManager(logger, mcpServer, promptManager, configManager, conversationManager, textReferenceManager, serviceManager, callbacks.fullServerRefresh, callbacks.restartServer);
    if (isVerbose)
