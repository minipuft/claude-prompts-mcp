...
export declare class ConsolidatedMcpToolsManager {
    ...
    constructor(logger: Logger, mcpServer: any, promptManager: PromptAssetManager, configManager: ConfigManager, conversationManager: ConversationManager, textReferenceManager: TextReferenceManager, serviceManager?: ServiceManager);
    /**
