...
export function renderPromptEngineGuide(goal) {
    ...
    sections.push('💡 Tip: Use the unified `gates` parameter to specify validation criteria. When combined with `llm_validation:true`, you can return `gate_verdict` for gate reviews. The response footer will remind you which verdict format to use.');
