...
import { createScriptHotReloadRegistration, isScriptToolFile, } from '../scripts/hot-reload/index.js';
/**
 ...
 */
export function buildScriptAuxiliaryReloadConfig(logger, scriptLoader, promptsDir) {
    if (!scriptLoader) {
    ...
    try {
        ...
        logger.warn('Failed to configure script tool hot reload; continuing without script reload:', error);
        return undefined;
    }
}
//# sourceMappingURL=script-hot-reload.js.map