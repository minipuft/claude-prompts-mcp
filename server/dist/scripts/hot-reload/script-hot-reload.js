 ...
 */
export function createScriptHotReloadRegistration(logger, scriptLoader, promptsDir) {
 ...
 */
export function isScriptToolFile(filePath) {
 ...
 */
export function extractPromptDirFromPath(filePath) {
    const normalizedPath = filePath.replace(/\\/g, '/');
 ...
 */
export function extractToolIdFromPath(filePath) {
    const normalizedPath = filePath.replace(/\\/g, '/');
    // Match: /tools/{tool_id}/
