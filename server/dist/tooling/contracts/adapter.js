 ...
 */
export function contractToParameterDescriptors(contract) {
 ...
 */
export function contractToCommandDescriptors(contract) {
 ...
 */
export function contractToZodObject(contract) {
    const shape = {};
