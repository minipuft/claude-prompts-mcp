...
import { system_controlCommands, system_controlParameters, } from '../../../tooling/contracts/_generated/system_control.generated.js';
...
const systemControlContract = {
    tool: 'system_control',
    version: 1,
    summary: 'Runtime administration (status, framework, analytics, diagnostics). One action per call—set `action` and required fields; chain admin steps with separate calls.',
    parameters: system_controlParameters,
    commands: system_controlCommands,
};
const parameterDescriptors = contractToParameterDescriptors(systemControlContract);
const commandDescriptors = contractToCommandDescriptors(systemControlContract);
export const systemControlMetadata = {
    tool: 'system_control',
