...
import { prompt_managerCommands, prompt_managerParameters, } from '../../../tooling/contracts/_generated/prompt_manager.generated.js';
...
const promptManagerActions = [
    ...
    },
    {
        ...
        status: 'working',
        requiredArgs: ['id'],
        description: 'Runs semantic analyzer to recommend single vs chain execution with % modifier hints.',
    },
    {
        id: 'analyze_gates',
    ...
    },
    {
        ...
        status: 'working',
        requiredArgs: ['id'],
        description: 'View version history for a prompt. Shows past versions with timestamps and diffs.',
    },
    {
        id: 'rollback',
        ...
        description: 'Rollback a prompt to a previous version. Requires confirm:true. Current state is saved before rollback.',
    },
    {
        id: 'compare',
...
const promptManagerContract = {
    tool: 'prompt_manager',
    version: 1,
    summary: 'Prompt and chain lifecycle management (create, update, list, analyze, reload, delete). One action per call—include `action` plus the fields for that operation.',
    parameters: prompt_managerParameters,
    commands: prompt_managerCommands,
};
const parameterDescriptors = contractToParameterDescriptors(promptManagerContract);
const commandDescriptors = contractToCommandDescriptors(promptManagerContract);
export const promptManagerMetadata = {
    tool: 'prompt_manager',
