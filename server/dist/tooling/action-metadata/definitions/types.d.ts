export type LifecycleStatus = 'working' | 'needs-structure' | 'needs-parameter' | 'needs-context' | 'routing_issue' | 'display-gap' | 'needs-validation' | 'needs-visuals' | 'planned' | 'untested' | 'deprecated' | 'hidden' | 'experimental';
