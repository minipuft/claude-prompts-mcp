 ...
 */
export declare function isChainPrompt(prompt: ConvertedPrompt): boolean;
/**
 * Get the number of steps in a chain prompt
 */
export declare function getChainStepCount(prompt: ConvertedPrompt): number;
/**
 ...
 */
export declare function hasValidChainSteps(prompt: ConvertedPrompt): boolean;
/**
 * Get chain information summary for a prompt
 */
export declare function getChainInfo(prompt: ConvertedPrompt): {
    isChain: boolean;
    stepCount: number;
    isValid: boolean;
};
 ...
 */
export declare function isValidChain(prompt: ConvertedPrompt): boolean;
