 ...
 */
export async function ensureCategoryExistsOnDisk({ logger, category, promptsConfig, promptsFile, }) {
 ...
 */
export async function cleanupEmptyCategoryOnDisk({ logger, categoryImport, promptsConfig, promptsFile, }) {
 ...
 */
export async function isCategoryImportEmpty(logger, categoryImport, promptsFile) {
    try {
        const promptsConfigDir = path.dirname(promptsFile);
        const categoryPath = path.join(promptsConfigDir, categoryImport);
 ...
 */
export async function getCategoryStatsFromDisk(categories, promptsFile) {
    const stats = {};
    const promptsConfigDir = path.dirname(promptsFile);
 ...
 */
export async function validateCategoryStructureOnDisk(categoryImport, promptsFile) {
    const issues = [];
    const promptsConfigDir = path.dirname(promptsFile);
    const categoryPath = path.join(promptsConfigDir, categoryImport);
    try {
 ...
 */
export function discoverYamlPromptsInCategory(categoryDir) {
 ...
 */
export function findYamlPromptInCategory(categoryDir, promptId) {
 ...
 */
export function hasYamlPromptsInCategory(categoryDir) {
 ...
 */
export async function deleteYamlPrompt(promptInfo) {
    const deletedPaths = [];
    try {
...
//# sourceMappingURL=category-maintenance.js.map