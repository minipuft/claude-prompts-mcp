...
export const PromptYamlSchema = z
    ...
    message: 'Prompt must have either userMessageTemplate/userMessageTemplateFile or chainSteps defined',
});
/**
 ...
 * ```
 */
export function validatePromptYaml(data, expectedId) {
    const errors = [];
    const warnings = [];
    // Schema validation
    ...
    if (definition.userMessageTemplateFile && definition.userMessageTemplate) {
        warnings.push('Both userMessageTemplateFile and userMessageTemplate specified - file will be used');
    }
 ...
 */
export function isValidPromptYaml(data) {
 ...
 * ```
 */
export function validatePromptSchema(data, expectedId) {
    const errors = [];
    const warnings = [];
    // Schema validation
 ...
 */
export function validatePromptsFile(data) {
    const errors = [];
    const warnings = [];
 ...
 * @returns Validation result with errors and warnings
 */
export function validatePromptsConfig(data) {
    const errors = [];
    const warnings = [];
 ...
 */
export function isValidPromptData(data) {
 ...
 */
export function isValidCategory(data) {
