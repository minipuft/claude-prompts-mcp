...
import { validateStyleSchema, } from './style-schema.js';
...
export class StyleDefinitionLoader {
        ...
        try {
            ...
            if (this.validateOnLoad) {
                ...
                if (!validation.valid) {
                    ...
                    console.error(`[StyleDefinitionLoader] Validation failed for '${id}':`, validation.errors.join('; '));
                    return undefined;
                }
     ...
     */
    inlineReferencedFiles(definition, styleDir) {
        ...
        if (guidanceFile) {
            ...
            if (existsSync(guidancePath)) {
                try {
                    ...
                    console.warn(`[StyleDefinitionLoader] Failed to inline guidance from ${guidancePath}:`, error);
                }
            }
            else {
 ...
 */
export function createStyleDefinitionLoader(config) {
 ...
 */
export function resetDefaultStyleDefinitionLoader() {
    defaultLoader = null;
}
//# sourceMappingURL=style-definition-loader.js.map