 ...
 */
import { z } from 'zod';
import { validateWithSchema } from '../../utils/schema-validator.js';
...
const lightweightGateSchema = z
    ...
    .passthrough();
export function validateLightweightGateDefinition(value) {
...
//# sourceMappingURL=gate-definition-schema.js.map