...
export class GateGuidanceRenderer {
     ...
     */
    async renderGuidance(gateIds, context = {}) {
     ...
     */
    async loadGateDefinition(gateId) {
     ...
     */
    isGateActive(gate, context, explicit = false) {
        const activationContext = { explicitRequest: explicit };
        if (context.category) {
     ...
     */
    formatGateGuidance(gate, context) {
     ...
     */
    async getAvailableGateDefinitions() {
 ...
 */
export function createGateGuidanceRenderer(logger, options) {
    return new GateGuidanceRenderer(logger, options);
}
//# sourceMappingURL=GateGuidanceRenderer.js.map