...
const DEFAULT_SEVERITY_TO_ENFORCEMENT = {
    critical: 'blocking',
    high: 'advisory',
    medium: 'advisory',
    low: 'informational',
...
export class GenericGateGuide {
     ...
     */
    checkFrameworkGateActivation(activation, context) {
     ...
     */
    checkRegularGateActivation(activation, context) {
        const categoryRules = activation.prompt_categories;
        const frameworkRules = activation.framework_context;
        const promptCategory = context.promptCategory;
        const framework = context.framework;
     ...
     */
    evaluateCriteria(criteria, content, _context) {
     ...
     */
    evaluateContentCheck(criteria, content) {
        const messages = [];
        let passed = true;
     ...
     */
    evaluatePatternCheck(criteria, content) {
        const messages = [];
        let passed = true;
 ...
 */
export function createGenericGateGuide(definition) {
    return new GenericGateGuide(definition);
}
//# sourceMappingURL=generic-gate-guide.js.map