 ...
 */
export function createGateLoader(logger, gatesDirectory, temporaryGateRegistry) {
    return new GateLoader(logger, gatesDirectory, temporaryGateRegistry);
}
//# sourceMappingURL=gate-loader.js.map