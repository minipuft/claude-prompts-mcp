...
export class MethodologyRegistry {
    ...
    async loadBuiltInGuides() {
        ...
        for (const id of builtInIds) {
            ...
            if (!definition) {
                throw new Error(`FATAL: Methodology '${id}' not found. Expected: resources/methodologies/${id}/methodology.yaml`);
            }
            const guide = createGenericGuide(definition);
    ...
    validateGuide(guide) {
        ...
        if ((!guide.type && !guide.methodology) ||
