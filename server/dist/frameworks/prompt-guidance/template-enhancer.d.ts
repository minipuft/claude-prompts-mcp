...
export declare class TemplateEnhancer {
     ...
     */
    enhanceTemplate(template: string, prompt: ConvertedPrompt, _methodologyGuide?: any, _framework?: any, _context?: any, semanticAnalysis?: ContentAnalysisResult, availableResources?: ConvertedPrompt[]): Promise<{
