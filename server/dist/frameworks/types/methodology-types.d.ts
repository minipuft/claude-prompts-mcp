 ...
 */
export declare const BUILTIN_FRAMEWORK_TYPES: readonly ["CAGEERF", "ReACT", "5W1H", "SCAMPER"];
/**
 ...
 */
export declare function isBuiltinFramework(type: string): type is BuiltinFrameworkType;
/**
 ...
 */
export declare abstract class BaseMethodologyGuide implements IMethodologyGuide {
    ...
    abstract guidePromptCreation(intent: string, context?: Record<string, any>): PromptCreationGuidance;
    abstract guideTemplateProcessing(template: string, executionType: ExecutionType): ProcessingGuidance;
    abstract guideExecutionSteps(prompt: ConvertedPrompt, semanticAnalysis: ContentAnalysisResult): StepGuidance;
    abstract enhanceWithMethodology(prompt: ConvertedPrompt, context: Record<string, any>): MethodologyEnhancement;
