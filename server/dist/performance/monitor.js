...
export class PerformanceMonitor {
    ...
    scheduleOptimization() {
        ...
        const shouldOptimize = timeSinceLastOptimization > this.optimizationInterval ||
 ...
 */
export function createPerformanceMonitor(logger, thresholds) {
