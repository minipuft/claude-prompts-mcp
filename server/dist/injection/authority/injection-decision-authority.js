 ...
 * ```typescript
 * // In a pipeline stage
 * const decision = injectionAuthority.decide({
 ...
 * ```
 */
export class InjectionDecisionAuthority {
    constructor(config, logger) {
        ...
        this.logger = logger;
        this.resolver = new DecisionResolver(config, logger);
    ...
    decide(input) {
        ...
        this.logger.debug('[InjectionDecisionAuthority] Decision made', {
    ...
    setRuntimeOverride(override) {
        ...
        this.logger.debug('[InjectionDecisionAuthority] Runtime override set', {
            type: override.type,
    ...
    clearRuntimeOverride(type) {
        ...
        this.logger.debug('[InjectionDecisionAuthority] Runtime override cleared', {
            type,
        });
    }
    /**
    ...
    clearAllRuntimeOverrides() {
        ...
        this.decisions.clear();
        this.logger.debug('[InjectionDecisionAuthority] All runtime overrides cleared');
    }
    /**
...
//# sourceMappingURL=injection-decision-authority.js.map