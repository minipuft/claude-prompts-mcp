    ...
    generateRecommendations() {
        ...
        if (frameworks.length > 1) {
            ...
            if (bestPerf !== undefined &&
                ...
                recommendations.push(`Consider switching to ${bestFramework} framework for better performance (${Math.round(bestSuccessRate * 100)}% success rate).`);
            }
        }
