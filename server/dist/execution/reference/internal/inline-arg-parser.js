 ...
 */
const INLINE_ARG_PATTERN = /([a-zA-Z_][a-zA-Z0-9_]*)=(?:'([^']*)'|"([^"]*)"|(\d+(?:\.\d+)?)|(\btrue\b|\bfalse\b))/g;
/**
 ...
 */
export function parseInlineScriptArgs(argsString) {
    const args = {};
 ...
 */
export function validateInlineArgs(args, schema) {
    const errors = [];
...
//# sourceMappingURL=inline-arg-parser.js.map