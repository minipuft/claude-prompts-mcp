 ...
 * ```
 */
export function useDiscriminatedUnions() {
    const envValue = process.env.USE_DISCRIMINATED_UNIONS;
    // Explicit true enables the feature
...
export function getFeatureFlagStatus() {
    return {
        discriminatedUnions: useDiscriminatedUnions(),
    };
}
