...
export class StepExecutionStage extends BasePipelineStage {
    constructor(chainOperatorExecutor, chainSessionManager, logger, referenceResolver, scriptReferenceResolver) {
        super(logger);
    ...
    async executeChainStep(context) {
        ...
        if (isChainComplete) {
            ...
            context.executionResults = {
                content: 'Chain already complete. No further user_response is required unless a gate review is pending.',
                metadata: {
    ...
    async executeSinglePrompt(context) {
        ...
        const templateResult = await processTemplateWithRefs(prompt.userMessageTemplate, args, {}, this.referenceResolver, {
        ...
        if (context.frameworkContext?.systemPrompt &&
...
//# sourceMappingURL=09-execution-stage.js.map