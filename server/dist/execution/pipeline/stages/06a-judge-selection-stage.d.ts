...
export declare class JudgeSelectionStage extends BasePipelineStage {
    ...
    constructor(promptsProvider: PromptsProvider | null, gateLoader: GateDefinitionProvider | null, configManager: ConfigManager | null, logger: Logger, frameworksProvider?: (FrameworkResourceProvider | null) | undefined, styleManager?: (StyleManager | null) | undefined);
