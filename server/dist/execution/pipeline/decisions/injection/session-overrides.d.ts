import type { InjectionRuntimeOverride, InjectionTarget, InjectionType } from './types.js';
...
export declare class SessionOverrideManager {
     ...
     */
    setOverride(type: InjectionType, enabled: boolean | undefined, scope?: 'session' | 'chain' | 'step', scopeId?: string, expiresInMs?: number, target?: InjectionTarget): InjectionRuntimeOverride;
    /**
