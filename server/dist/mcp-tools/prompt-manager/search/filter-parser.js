...
export class FilterParser {
     ...
     */
    parseIntelligentFilters(filterText) {
        const filters = {};
        if (!filterText)
            return filters;
        try {
     ...
     */
    parseTypeFilter(filterText, filters) {
     ...
     */
    parseCategoryFilter(filterText, filters) {
     ...
     */
    parseIntentFilter(filterText, filters) {
     ...
     */
    parseExecutionFilter(filterText, filters) {
     ...
     */
    parseGatesFilter(filterText, filters) {
