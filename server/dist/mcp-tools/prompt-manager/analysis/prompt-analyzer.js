...
export class PromptAnalyzer {
     ...
     */
    async analyzePromptIntelligence(promptData) {
     ...
     */
    createFallbackAnalysis(prompt, error) {
    ...
    generateSuggestions(classification) {
        ...
        else if (classification.analysisMode === 'fallback' ||
