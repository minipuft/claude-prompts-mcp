...
export declare class PromptExecutionService {
    ...
    constructor(logger: Logger, mcpServer: any, promptManager: PromptAssetManager, configManager: ConfigManager, semanticAnalyzer: ContentAnalyzer, conversationManager: ConversationManager, textReferenceManager: TextReferenceManager, gateManager: GateManager, mcpToolsManager?: any, promptGuidanceService?: PromptGuidanceService);
