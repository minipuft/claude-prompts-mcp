...
function isPlausiblePromptId(token) {
 ...
 */
export function detectToolRoutingCommand(command) {
    ...
    if (trimmedCommand.startsWith('>>')) {
        ...
        const isAllowedPrefix = ALLOWED_PREFIX_TOKENS.some((prefix) => rest.toLowerCase().startsWith(prefix));
