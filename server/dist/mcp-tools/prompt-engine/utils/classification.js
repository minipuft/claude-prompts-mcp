...
export class PromptClassifier {
     ...
     */
    classifyPrompt(convertedPrompt, promptArgs = {}) {
        try {
     ...
     */
    performClassification(convertedPrompt, promptArgs) {
        const reasoning = [];
        let confidence = 100;
     ...
     */
    suggestFramework(convertedPrompt) {
     ...
     */
    assessComplexity(convertedPrompt) {
        let complexity = 0;
     ...
     */
    countTemplateVariables(content) {
