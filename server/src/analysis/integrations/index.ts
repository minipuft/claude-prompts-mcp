/**
 * Analysis Integrations Module
 * 
 * Central module for creating and managing analysis integrations
 * Handles LLM clients for semantic analysis
 */
...
import { 
  ...
  createConfigurableSemanticAnalyzer 
...
/**
 * Integration factory for configurable semantic analyzer
 */
export class AnalysisIntegrationFactory {
   ...
   */
  async createConfiguredAnalyzer(config: SemanticAnalysisConfig): Promise<ConfigurableSemanticAnalyzer> {
    const analyzer = createConfigurableSemanticAnalyzer(this.logger, config);
   ...
   */
  async createFromEnvironment(baseConfig: SemanticAnalysisConfig): Promise<ConfigurableSemanticAnalyzer> {
  ...
  generateConfigurationGuide(): string {
    return `
# Configurable Semantic Analysis Setup Guide
...
### Hybrid Mode
- **Description**: Structural analysis enhanced with pattern matching
- **Capabilities**: Better than structural, not as smart as semantic
- **Requirements**: None
- **Use Case**: Compromise between reliability and intelligence
...
export function createAnalysisIntegrationFactory(logger: Logger): AnalysisIntegrationFactory {
  return new AnalysisIntegrationFactory(logger);
}
