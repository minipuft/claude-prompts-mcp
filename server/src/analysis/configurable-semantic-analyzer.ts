/**
 * Configurable Semantic Analyzer - Honest Analysis with Multiple Modes
 * 
 * MODES:
 ...
 * - hybrid: Structural analysis enhanced with pattern matching
 * 
 * HONEST LIMITATIONS:
...
/**
 * Enhanced semantic analysis result with honest limitations reporting
 */
export interface ConfigurableSemanticAnalysis {
 ...
 */
export class ConfigurableSemanticAnalyzer {
  private logger: Logger;
  private config: SemanticAnalysisConfig;
  private analysisCache = new Map<string, { analysis: ConfigurableSemanticAnalysis; timestamp: number }>();
   ...
   */
  async analyzePrompt(prompt: ConvertedPrompt): Promise<ConfigurableSemanticAnalysis> {
  ...
  private async performModeSpecificAnalysis(
    ...
    startTime: number
  ): Promise<ConfigurableSemanticAnalysis> {
  ...
  private cacheAnalysis(promptHash: string, analysis: ConfigurableSemanticAnalysis): void {
...
/**
 * Create configurable semantic analyzer
 */
export function createConfigurableSemanticAnalyzer(
  logger: Logger, 
  config: SemanticAnalysisConfig
): ConfigurableSemanticAnalyzer {
  return new ConfigurableSemanticAnalyzer(logger, config);
}