// @lifecycle canonical - Abstract base class for resource handlers
/**
 ...
 * @example
 * ```typescript
 * class GateManager extends BaseResourceHandler<GateGuide, GateGuideEntry> {
...
import type { ResourceManagerStats, BaseResourceHandlerConfig } from './types.js';
 ...
 * @template TConfig - The configuration type (must extend BaseResourceHandlerConfig)
...
export abstract class BaseResourceHandler<
  TResource,
  TEntry = unknown,
  TConfig extends BaseResourceHandlerConfig = BaseResourceHandlerConfig,
