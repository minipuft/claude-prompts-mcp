...
skipped, `test:ci` 2171/2171, **`validate:all` 34/34 as of 2026-08-12** — the long-standing
`plans:retire:check` red is gone, fixed by the workstream that owned the offending plan.
