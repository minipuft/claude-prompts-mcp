...
| #   | St                                                                                                                                                                                                                    | File                                     | Change                                                                                                                             | ~Lines | Depends      | Verify                                              | Justification                                                  |
| --- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- | -----: | ------------ | --------------------------------------------------- | -------------------------------------------------------------- |
| 6.1 | ☐ (as of 2026-08-15 · flips when a PR closes #224 and every transition in Discussion #225 → Issue #224 → Project #1 → PR is inspectable with the records retained; the first three legs are live, the PR leg is open) | Windows hook-interpreter RFC (#225/#224) | Live-drive one useful RFC through Discussion, Issue/sub-issues, Project fields, plan tracking, and PR linkage; retain the records. |      0 | 5.5,5.6,OQ-3 | Inspect every transition and canonical owner        | Fixtures cannot validate permissions or human-visible flow.    |
