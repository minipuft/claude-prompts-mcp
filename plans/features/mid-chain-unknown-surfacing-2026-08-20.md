...
| F-1 | ☐ (as of 2026-08-31 · flips when a server-proposed remainder is accepted in a real run; ✗ if none by one release after 2026-08-31, the date row 5.1 shipped — the deadline was undatable while 5.1 was open and is now a date)                                                                                                                                                                                                                                                                                                                                                | `interrupt-policy.ts`                                                                                                                                                                                                                                                                                                                                                 | Follow-on: server-derived reorder `alternative` (advance nodes with no edge to the affected set) — IR runs with `edges` only; template chains have no dependency data                                                                                                                                                                                                                                                                                                                                                               | An accepted server-proposed remainder in a real run                                                                                                                                                                                                                                                       |
