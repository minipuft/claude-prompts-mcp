...
| 0.2 | ✓                                                                                                                                       | —                                 | Rule OQ-1..OQ-3 with the T0 evidence; update Decisions table                                                                 | RULED 2026-08-21, all four (OQ-1..4); pointers in §Open Questions                                                                                                                                                                                                                                                                          |
...
| 2.2 | ☐ (as of 2026-08-21 · flips when a two-server jest scenario exists; `server/scripts/verify-handoff.mjs` is the manual drive until then) | tests                             | Cross-process integration test: two spawned servers, one shared db, mint→claim→resume; foreign claim without token refused   | Test red against pre-1.3 code, green after                                                                                                                                                                                                                                                                                                 |
