...
for q in "mcp+prompt+server" "prompt+templates+mcp" "mcp+prompt+management"; do
  gh api "search/repositories?q=$q&per_page=20" --jq '[.items[].full_name] | index("minipuft/wolfflow-mcp")'
done
# npm rank
