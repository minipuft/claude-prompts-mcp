...
P1.1–P1.4 remain open as their own work. They are not gate criteria — the gate asks where resources
LIVE, which is settled; those rows ask how WRITES behave once a resource is resident, which the
