...
| Live drive             | `npm run build && npm run verify:mcp`, then the real client flow                                  | Driven 2026-08-17 against a gate registered at startup — F17 blocks the `create`-first form, tracked in `plans/reference/technical-debt/gate-registry-refresh-on-create-2026-08-17.md` |
