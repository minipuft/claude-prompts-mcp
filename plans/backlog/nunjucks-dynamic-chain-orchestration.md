---
title: "Nunjucks Dynamic Chain Orchestration - Implementation Plan"
date: 2025-10-05
status: backlog
tags: []
---
...
```json
{
  "steps": [
    ...
    {
      "promptId": "assessment",
      "outputMapping": { "adequate": "is_sufficient" }
    },
    {
      "promptId": "deep_analysis_conditional",
      "inputMapping": {
  ...
  "issues": [
    {
      "type": "clarity",
      "severity": "low",
      "description": "Section 3 could be clearer"
    }
  ],
...
const nextStepDecision = await llm.decide({
  prompt:
    "Based on these results, should we: A) Proceed to synthesis, B) Gather more research, C) Refine current analysis?",
