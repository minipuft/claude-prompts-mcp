...
Four primitives you author, version, and compose. The bundled set ships 40 prompts across 8 categories — a starting library, not the ceiling: your AI writes new prompts and chains through `resource_manager` as it works, so the set grows around what you actually do. All hot-reloadable, all versioned with rollback.
