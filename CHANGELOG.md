...
## [1.3.3](https://github.com/minipuft/claude-prompts/compare/v1.3.2...v1.3.3) (2026-01-17)


### Bug Fixes

* **release:** remove submodule path checks from distribution validation ([1a3220e](https://github.com/minipuft/claude-prompts/commit/1a3220e19e64dbada9ca90a1e6a84f7fc5651cbe))
